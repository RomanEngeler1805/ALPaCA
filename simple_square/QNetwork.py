...
class QNetwork():
    ...
    def _build_model(self):
        ...
        self.phi_max_target = tf.placeholder(shape=[None, self.latent_dim], dtype=tf.float32, name='phi_max_target')
        '''
        ...
        self.Qtarget = self.reward + self.gamma * tf.multiply(1 - self.done, self.Qmax)
