...
# domain
tf.flags.DEFINE_integer("action_space", 6, "Dimensionality of action space")  # only x-y currently
tf.flags.DEFINE_integer("state_space", 9, "Dimensionality of state space")  # [x,y,theta,vx,vy,vtheta]
...
tf.flags.DEFINE_float("regularizer", 1e0, "Regularization parameter") # X
