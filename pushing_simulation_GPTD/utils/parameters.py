...
def parameters():
    ...
    tf.flags.DEFINE_float("split_ratio", 0.60, "Initial split ratio for conditioning")
    tf.flags.DEFINE_float("split_ratio_max", 0.60, "Maximum split ratio for conditioning")
