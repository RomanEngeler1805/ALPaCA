...
class QNetwork():
    ...
    def _build_model(self):
        ...
        self.phi = self.model(self.state* tf.constant([1., 1., 1., 1., 10., 10., 1., 1.]), action_augm)  # latent space
        self.phi_next = self.model(self.state_next* tf.constant([1., 1., 1., 1., 10., 10., 1., 1.]), action_augm)  # latent space
        ...
        ## latent representation
        self.context_phi = self.model(self.context_state* tf.constant([1., 1., 1., 1., 10., 10., 1., 1.]), context_action_augm)  # latent space
        self.context_phi_next = self.model(self.context_state_next* tf.constant([1., 1., 1., 1., 10., 10., 1., 1.]), context_action_augm)  # latent space
