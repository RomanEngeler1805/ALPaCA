...
class HIVTreatment(object):
    ...
    **REFERENCE:**
    ...
    def step(self, action, perturb_params=False, **kw):
        return self._step(action, perturb_params, **self.param_set)

    def _step(self, action, perturb_params=False, p_lambda1=0, p_lambda2=0, p_k1=0, \
